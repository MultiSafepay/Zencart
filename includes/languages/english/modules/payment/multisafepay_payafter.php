...
define('MODULE_PAYMENT_MSP_PAYAFTER_TEXT_BIRTHDAY', 'Birthdate');
define('MODULE_PAYMENT_MSP_PAYAFTER_TEXT_PHONE', 'Phone');
define('MODULE_PAYMENT_MSP_PAYAFTER_TEXT_BANK_ACCOUNT', 'Bankaccount');
