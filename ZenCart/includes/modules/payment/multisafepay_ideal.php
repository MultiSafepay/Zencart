...
class multisafepay_ideal extends multisafepay
{
	...
	function install()
	{
		...
		$db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('Enable Direct iDeal', 'MODULE_PAYMENT_MSP_IDEAL_DIRECT', 'True', 'Select the bank within the website?', '6', '1', 'zen_cfg_select_option(array(\'True\', \'False\'), ', now())");
	}
